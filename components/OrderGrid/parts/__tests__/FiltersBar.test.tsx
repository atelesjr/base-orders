...
jest.mock('next/navigation', () => ({
	...
	usePathname: () => '/',
	useSearchParams: () => new URLSearchParams('page=2&sortBy=timestamp&sortDir=desc&side=Compra'),
}));
...
describe('OrdersGridFiltersBar', () => {
	...
	it('clears active filters and navigates to first page preserving sort', () => {
		...
		expect(pushMock).toHaveBeenCalledWith('/?page=1&sortBy=timestamp&sortDir=desc');
	});
});
